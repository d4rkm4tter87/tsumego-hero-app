...
JGO.BOARD.medium = {
    textures: {
        black: '/medium/blackGalaxy.png',
        white: '/medium/whiteGalaxy.png',
    ...
    boardShadow: {color: '#6c6c95', blur: 22.5, offX: 3.75, offY: 3.75},
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: '/large/texture55.png', shadow: '/medium/shadow_dark.png'},
    boardShadow: {color: '#5d5d82'},
    grid: {color: '#272933', borderWidth: 1.6, lineWidth: 1.3}
});
