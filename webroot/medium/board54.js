...
JGO.BOARD.medium = {
    textures: {
        black: '/medium/black54.png',
        white: '/medium/white54.png',
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: '/large/texture54.png', shadow: '/medium/shadow_dark.png'},
    boardShadow: {color: '#fff'},
    grid: {color: '#666', borderWidth: 1.6, lineWidth: 1.3}
});
