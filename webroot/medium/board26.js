...
JGO.BOARD.medium = {
    textures: {
        black: '/medium/blackInvis.png',
        white: '/medium/whiteCarnage.png',
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: '/large/texture26.png', shadow: '/medium/shadow_dark.png'},
    boardShadow: {color: '#a12b2b'},
    grid: {color: '#bbb', borderWidth: 1.6, lineWidth: 1.3}
});
