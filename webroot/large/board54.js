...
JGO.BOARD.large = {
    textures: {
        black: '/large/black54.png',
        white: '/large/white54.png',
...
JGO.BOARD.largeWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.large), {
	textures: {board: '/large/texture54.png', shadow: '/large/shadow_dark.png'},
    boardShadow: {color: '#fff'},
    grid: {color: '#777', borderWidth: 1.8, lineWidth: 1.5}
});
