...
JGO.BOARD.large = {
    textures: {
        black: '/large/black32.png',
        white: '/large/white32.png',
...
JGO.BOARD.largeWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.large), {
	textures: {board: '/large/texture33.png', shadow: '/large/shadow_dark.png'},
    boardShadow: {color: '#333'},
    grid: {color: '#444', borderWidth: 1.8, lineWidth: 1.5}
});
