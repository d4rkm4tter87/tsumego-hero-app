...
JGO.BOARD.large = {
    textures: {
        black: '/large/blackGalaxy.png',
        white: '/large/whiteGalaxy.png',
...
JGO.BOARD.largeWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.large), {
	textures: {board: '/large/texture55.png', shadow: '/large/shadow_dark.png'},
    boardShadow: {color: '#5d5d82'},
    grid: {color: '#272933', borderWidth: 1.8, lineWidth: 1.5}
});
