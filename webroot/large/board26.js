...
JGO.BOARD.large = {
    textures: {
        black: '/large/blackInvis.png',
        white: '/large/whiteCarnage.png',
...
JGO.BOARD.largeWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.large), {
	textures: {board: '/large/texture26.png', shadow: '/large/shadow_dark.png'},
    boardShadow: {color: '#a12b2b'},
    grid: {color: '#bbb', borderWidth: 1.8, lineWidth: 1.5}
});
