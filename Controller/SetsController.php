...
class SetsController extends AppController{
	...
	private function getHealth($lvl = null)
  {
	...
	private function getTopicColor($id = null){
		$colors = array();
		array_push($colors, '#99c44c');//0
		array_push($colors, '#60167d');//1
		array_push($colors, '#a432ec');//2
		array_push($colors, '#ef3074');//3
		array_push($colors, '#00bbb5');//4
		array_push($colors, '#4122b3');//5
		array_push($colors, '#000000');//6
		array_push($colors, '#2fc136');//7
		array_push($colors, '#0022b5');//8
		array_push($colors, '#d2b43a');//9
		array_push($colors, '#4c4de3');//10
		array_push($colors, '#c880e4');//11
		array_push($colors, '#000');//12
		array_push($colors, '#e75844');//13
		array_push($colors, '#e75844');//14
		array_push($colors, '#509135');//15
		array_push($colors, '#cca77a');//16
		array_push($colors, '#82737b');//17
		array_push($colors, '#3c1358');//18
		array_push($colors, '#ef7271');//19
		array_push($colors, '#2e2e2e');//20
		array_push($colors, '#3cb08c');//21
		array_push($colors, '#742499');//22
		array_push($colors, '#fc895e');//23
		array_push($colors, '#caaa59');//24
		array_push($colors, '#2d4e56');//25
		
		if($id==40) return $colors[0];
		if($id==37) return $colors[1];
		if($id==43) return $colors[1];
		if($id==44) return $colors[1];
		if($id==45) return $colors[1];
		if($id==46) return $colors[1];
		if($id==47) return $colors[1];
		if($id==38) return $colors[2];
		if($id==48) return $colors[2];
		if($id==39) return $colors[3];
		if($id==41) return $colors[4];
		if($id==49) return $colors[4];
		if($id==42) return $colors[5];
		if($id==50) return $colors[4];
		if($id==51) return $colors[4];
		if($id==52) return $colors[4];
		if($id==53) return $colors[4];
		if($id==54) return $colors[4];
		if($id==56) return $colors[4];
		if($id==57) return $colors[4];
		if($id==58) return $colors[5];
		if($id==59) return $colors[7];
		if($id==60) return $colors[7];
		if($id==61) return $colors[7];
		if($id==62) return $colors[11];
		if($id==63) return $colors[9];
		if($id==65) return $colors[4];
		if($id==66) return $colors[4];
		if($id==67) return $colors[10];
		if($id==68) return $colors[8];
		if($id==69) return $colors[10];
		if($id==70) return $colors[11];
		if($id==71) return $colors[10];
		if($id==81) return $colors[10];
		if($id==82) return $colors[10];
		if($id==83) return $colors[10];
		if($id==84) return $colors[12];
		if($id==85) return $colors[12];
		if($id==90) return $colors[12];
		if($id==91) return $colors[11];
		if($id==92) return $colors[10];
		if($id==94) return $colors[12];
		if($id==97) return $colors[12];
		if($id==98) return $colors[12];
		if($id==99) return $colors[12];
		if($id==100) return $colors[12];
		if($id==101) return $colors[12];
		if($id==102) return $colors[11];
		if($id==103) return $colors[11];
		if($id==104) return $colors[11];
		if($id==105) return $colors[11];
		if($id==106) return $colors[12];
		if($id==107) return $colors[12];
		if($id==108) return $colors[12];
		if($id==109) return $colors[15];
		if($id==110) return $colors[13];
		if($id==111) return $colors[13];
		if($id==112) return $colors[9];
		if($id==113) return $colors[13];
		if($id==114) return $colors[9];
		if($id==115) return $colors[13];
		if($id==116) return $colors[11];
		if($id==117) return $colors[11];
		if($id==118) return $colors[4];
		if($id==119) return $colors[4];
		if($id==120) return $colors[16];
		if($id==121) return $colors[9];
		if($id==122) return $colors[16];
		if($id==123) return $colors[16];
		if($id==124) return $colors[16];
		if($id==125) return $colors[16];
		if($id==127) return $colors[16];
		if($id==128) return $colors[4];
		if($id==125) return $colors[16];
		if($id==125) return $colors[16];
		if($id==130) return $colors[16];
		if($id==131) return $colors[16];
		if($id==132) return $colors[16];
		if($id==133) return $colors[16];
		if($id==136) return $colors[17];
		if($id==137) return $colors[17];
		if($id==138) return $colors[16];
		if($id==139) return $colors[16];
		if($id==140) return $colors[13];
		if($id==141) return $colors[17];
		if($id==142) return $colors[18];
		if($id==143) return $colors[18];
		if($id==144) return $colors[19];
		if($id==145) return $colors[19];
		if($id==146) return $colors[20];
		if($id==147) return $colors[20];
		if($id==148) return $colors[13];
		if($id==149) return $colors[21];
		if($id==150) return $colors[21];
		if($id==151) return $colors[21];
		if($id==152) return $colors[23];
		if($id==153) return $colors[20];
		if($id==154) return $colors[21];
		if($id==155) return $colors[24];
		if($id==156) return $colors[13];
		if($id==157) return $colors[21];
		if($id==158) return $colors[23];
		if($id==159) return $colors[21];
		if($id==160) return $colors[24];
		if($id==161) return $colors[12];
		if($id==162) return $colors[25];
		if($id==163) return $colors[25];
		if($id==164) return $colors[17];
		if($id==11969) return $colors[6];
		if($id==29156) return $colors[6];
		if($id==31813) return $colors[6];
		if($id==33007) return $colors[6];
		if($id==71790) return $colors[6];
		if($id==74761) return $colors[6];
		if($id==81578) return $colors[6];
		if($id==88156) return $colors[6];
		return '#777777';
	}
